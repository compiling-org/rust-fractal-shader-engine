/*
{
  "DESCRIPTION": "A new fractal variant converted to ISF, with controls for Ambient Occlusion, Vignette, Glow, Fog, Shadows, Lighting, Rendering, Coloring, Refraction, new manual fractal/camera controls, and image textures.",
  "CATEGORIES": [ "Fractal", "3D", "Procedural", "Abstract", "Texture" ],
  "ISF_VERSION": "2.0",
  "INPUTS": [
    ...
    { "NAME": "speed", "TYPE": "float", "DEFAULT": 1.5, "MIN": 0.1, "MAX": 5.0, "DESCRIPTION": "Overall animation speed multiplier for camera." },
    ...
    { "NAME": "camera_base_x", "TYPE": "float", "DEFAULT": 8.0, "MIN": -20.0, "MAX": 20.0, "DESCRIPTION": "Base X position for camera." },
    { "NAME": "camera_base_y", "TYPE": "float", "DEFAULT": 2.2, "MIN": -20.0, "MAX": 20.0, "DESCRIPTION": "Base Y position for camera." },
    { "NAME": "camera_base_z", "TYPE": "float", "DEFAULT": 2.0, "MIN": -20.0, "MAX": 20.0, "DESCRIPTION": "Base Z position for camera." },
    { "NAME": "camera_amplitude", "TYPE": "float", "DEFAULT": 2.5, "MIN": 0.0, "MAX": 10.0, "DESCRIPTION": "Amplitude of camera Z oscillation." },
    { "NAME": "camera_frequency", "TYPE": "float", "DEFAULT": 0.1, "MIN": 0.01, "MAX": 1.0, "DESCRIPTION": "Frequency of camera Z oscillation." },
    { "NAME": "camera_phase", "TYPE": "float", "DEFAULT": 7.0, "MIN": 0.0, "MAX": 10.0, "DESCRIPTION": "Phase offset for camera Z oscillation." },
    { "NAME": "camera_roll", "TYPE": "float", "DEFAULT": 1.0, "MIN": -3.14, "MAX": 3.14, "DESCRIPTION": "Camera roll angle." },
    { "NAME": "zoom_factor", "TYPE": "float", "DEFAULT": 3.5, "MIN": 0.1, "MAX": 10.0, "DESCRIPTION": "Camera zoom level (higher value means more zoomed in)." },
    { "NAME": "camera_offset_x", "TYPE": "float", "DEFAULT": 0.0, "MIN": -10.0, "MAX": 10.0, "DESCRIPTION": "Manual camera target X offset." },
    { "NAME": "camera_offset_y", "TYPE": "float", "DEFAULT": 0.0, "MIN": -10.0, "MAX": 10.0, "DESCRIPTION": "Manual camera target Y offset." },
    { "NAME": "camera_offset_z", "TYPE": "float", "DEFAULT": 0.0, "MIN": -10.0, "MAX": 10.0, "DESCRIPTION": "Manual camera target Z offset." },
...
// Image Texture Uniforms (explicitly declared as sampler2D)
uniform sampler2D inputTex1;
uniform sampler2D inputTex2; // Unused in current implementation, but available
...
// Fractal function - directly from your code, adapted for ISF inputs
vec2 mixpinski_sdf(vec3 point3d) {
    vec4 p = vec4(point3d, 0.0); // *** FIX: Re-inserted p declaration ***
    float scale = fractal_power; // Use fractal_power input
    float orbit_trap = 1000000.0;
	int i = 0;
    
    // Use new manual fractal offsets and rotations
...
void main() { // ISF entry point
	...
	float time = 32.0 + TIME * speed; 

    // Camera target and origin with ISF input offsets
    vec3 ta = vec3( camera_offset_x, camera_offset_y, camera_offset_z ); // Now correctly defined in JSON
    vec3 ro = vec3(camera_base_x, camera_base_y, camera_base_z + camera_amplitude * sin(camera_frequency * time + camera_phase) ); // Adapted camera motion
