/*
{
  "DESCRIPTION": "Mixpinski Fractal Tunnel converted to ISF, with controls for Ambient Occlusion, Vignette, Glow, Fog, Shadows, Lighting, Rendering, Coloring, Refraction, new manual fractal controls, and image textures.",
  "CATEGORIES": [ "Fractal", "Tunnel", "3D", "Procedural", "Abstract", "Texture" ],
  "ISF_VERSION": "2.0",
  "INPUTS": [
    ...
    { "NAME": "speed", "TYPE": "float", "DEFAULT": 1.5, "MIN": 0.1, "MAX": 5.0, "DESCRIPTION": "Overall animation speed multiplier." },
    ...
    { "NAME": "ambient_occlusion_darkness", "TYPE": "float", "DEFAULT": 0.67, "MIN": 0.0, "MAX": 1.0, "DESCRIPTION": "Strength of Ambient Occlusion darkening." },
    ...
    { "NAME": "glow_threshold", "TYPE": "float", "DEFAULT": 5.0, "MIN": 0.0, "MAX": 100.0, "DESCRIPTION": "Distance threshold for glow activation." },
    { "NAME": "glow_falloff", "TYPE": "float", "DEFAULT": 1.1, "MIN": 0.1, "MAX": 5.0, "DESCRIPTION": "Falloff rate of the glow effect." },
    ...
    { "NAME": "fog_density", "TYPE": "float", "DEFAULT": 0.1, "MIN": 0.0, "MAX": 1.0, "DESCRIPTION": "Density of the fog." },
    ...
    { "NAME": "shadow_darkness", "TYPE": "float", "DEFAULT": 0.6, "MIN": 0.0, "MAX": 1.0, "DESCRIPTION": "Darkness multiplier for shadows." },
    ...
    { "NAME": "light_intensity", "TYPE": "float", "DEFAULT": 10.6, "MIN": 0.0, "MAX": 50.0, "DESCRIPTION": "Overall intensity of lights." },
    ...
    { "NAME": "iterations", "TYPE": "float", "DEFAULT": 13.0, "MIN": 1.0, "MAX": 50.0, "STEP": 1.0, "DESCRIPTION": "Number of fractal iterations." },
    { "NAME": "max_steps", "TYPE": "float", "DEFAULT": 320.0, "MIN": 1.0, "MAX": 500.0, "STEP": 1.0, "DESCRIPTION": "Maximum raymarch steps." },
    { "NAME": "ambient_light", "TYPE": "float", "DEFAULT": 0.9, "MIN": 0.0, "MAX": 1.0, "DESCRIPTION": "Ambient light contribution." },
    { "NAME": "max_distance", "TYPE": "float", "DEFAULT": 20.0, "MIN": 1.0, "MAX": 100.0, "DESCRIPTION": "Maximum raymarch distance." },
    { "NAME": "surface_distance", "TYPE": "float", "DEFAULT": 0.003, "MIN": 0.00001, "MAX": 0.1, "DESCRIPTION": "Distance to consider a surface hit." },
    ...
    { "NAME": "palette_color1_r", "TYPE": "float", "DEFAULT": 0.0, "MIN": 0.0, "MAX": 1.0, "DESCRIPTION": "Red component of first palette color." },
    { "NAME": "palette_color1_g", "TYPE": "float", "DEFAULT": 0.8, "MIN": 0.0, "MAX": 1.0, "DESCRIPTION": "Green component of first palette color." },
    { "NAME": "palette_color1_b", "TYPE": "float", "DEFAULT": 1.0, "MIN": 0.0, "MAX": 1.0, "DESCRIPTION": "Blue component of first palette color." },
    { "NAME": "palette_color2_r", "TYPE": "float", "DEFAULT": 1.0, "MIN": 0.0, "MAX": 1.0, "DESCRIPTION": "Red component of second palette color." },
    { "NAME": "palette_color2_g", "TYPE": "float", "DEFAULT": 0.5, "MIN": 0.0, "MAX": 1.0, "DESCRIPTION": "Green component of second palette color." },
    ...
    { "NAME": "power", "TYPE": "float", "DEFAULT": 2.0, "MIN": 1.0, "MAX": 4.0, "DESCRIPTION": "Fractal power parameter." },
    { "NAME": "camera_offset_x", "TYPE": "float", "DEFAULT": 0.0, "MIN": -10.0, "MAX": 10.0, "DESCRIPTION": "Manual camera X offset." },
    { "NAME": "camera_offset_y", "TYPE": "float", "DEFAULT": 0.0, "MIN": -10.0, "MAX": 10.0, "DESCRIPTION": "Manual camera Y offset." },
    { "NAME": "camera_offset_z", "TYPE": "float", "DEFAULT": 0.0, "MIN": -10.0, "MAX": 10.0, "DESCRIPTION": "Manual camera Z offset." },
    { "NAME": "zoom_factor", "TYPE": "float", "DEFAULT": 3.5, "MIN": 0.1, "MAX": 10.0, "DESCRIPTION": "Camera zoom level (higher value means more zoomed in)." },
    { "NAME": "fractal_offset_x", "TYPE": "float", "DEFAULT": 1.8, "MIN": -5.0, "MAX": 5.0, "DESCRIPTION": "X offset for fractal transformation." },
    { "NAME": "fractal_offset_y", "TYPE": "float", "DEFAULT": 1.04, "MIN": -5.0, "MAX": 5.0, "DESCRIPTION": "Y offset for fractal transformation." },
    { "NAME": "fractal_offset_z", "TYPE": "float", "DEFAULT": 1.0, "MIN": -5.0, "MAX": 5.0, "DESCRIPTION": "Z offset for fractal transformation." },
    { "NAME": "fractal_offset_w", "TYPE": "float", "DEFAULT": 1.0, "MIN": -5.0, "MAX": 5.0, "DESCRIPTION": "W offset for fractal transformation." },
    { "NAME": "fractal_rotation_x", "TYPE": "float", "DEFAULT": 0.0, "MIN": -3.14, "MAX": 3.14, "DESCRIPTION": "X-axis rotation for fractal transformation." },
    { "NAME": "fractal_rotation_y", "TYPE": "float", "DEFAULT": 0.0, "MIN": -3.14, "MAX": 3.14, "DESCRIPTION": "Y-axis rotation for fractal transformation." },
    { "NAME": "fractal_rotation_z", "TYPE": "float", "DEFAULT": 0.02, "MIN": -3.14, "MAX": 3.14, "DESCRIPTION": "Z-axis rotation for fractal transformation." },
    { "NAME": "fractal_rotation_w", "TYPE": "float", "DEFAULT": 0.0, "MIN": -3.14, "MAX": 3.14, "DESCRIPTION": "W-axis rotation for fractal transformation." },
...
vec2 mixpinski_sdf(vec3 point3d);
...
// Mixpinski SDF function - directly from your code
vec2 mixpinski_sdf(vec3 point3d) {
    // All these variables are implicitly passed from the JSON INPUTS as floats
    // float power;
    // float iterations;
    // float fractal_offset_x, fractal_offset_y, fractal_offset_z, fractal_offset_w;
    // float fractal_rotation_x, fractal_rotation_y, fractal_rotation_z, fractal_rotation_w;

    vec4 p = vec4(point3d, 0.0);
    float scale = power;
    float orbit_trap = 1000000.0;
    int i = 0;
    
    // Use the new manual fractal offset and rotation inputs
    vec4 offset = vec4(fractal_offset_x, fractal_offset_y, fractal_offset_z, fractal_offset_w);
    vec4 rotation = vec4(fractal_rotation_x, fractal_rotation_y, fractal_rotation_z, fractal_rotation_w);

    for (; i < int(iterations); i++) { // Cast iterations to int
        p.xz = vec2(cos(rotation.x) * p.x - sin(rotation.x) * p.z, sin(rotation.x) * p.x + cos(rotation.x) * p.z); // Y-axis rotation
        p.yz = vec2(cos(rotation.y) * p.y - sin(rotation.y) * p.z, sin(rotation.y) * p.y + cos(rotation.y) * p.z);     // X-axis rotation
        ...
        p.xz = vec2(cos(rotation.z) * p.x - sin(rotation.z) * p.z, sin(rotation.z) * p.x + cos(rotation.z) * p.z); // Y-axis rotation
        p.yz = vec2(cos(rotation.w) * p.y - sin(rotation.w) * p.z, sin(rotation.w) * p.y + cos(rotation.w) * p.z);     // X-axis rotation

        orbit_trap = min(orbit_trap, dot(p, p));
    }

    float d = length(p) * pow(scale, float(-i-1));
    return vec2(orbit_trap / 2.3, 0.9 * d);
}
...
vec3 ray_marcher(vec3 ro, vec3 rd) {
    ...
    for (int i = 0; i < int(max_steps); i++) { // Cast max_steps to int
        vec2 data = mixpinski_sdf(ro + rd * dfo);
...
float soft_shadow(vec3 p, vec3 light_pos, float k) {
    ...
    for (int i = 0; i < int(shadow_steps); i++) { // Cast shadow_steps to int
        float h = mixpinski_sdf(p + rd * t).y;
...
vec3 calculate_normal(vec3 p) {
    ...
    return normalize(vec3(
        mixpinski_sdf(p + vec3(h, 0.0, 0.0)).y - mixpinski_sdf(p - vec3(h, 0.0, 0.0)).y,
        mixpinski_sdf(p + vec3(0.0, h, 0.0)).y - mixpinski_sdf(p - vec3(0.0, h, 0.0)).y,
        mixpinski_sdf(p + vec3(0.0, 0.0, h)).y - mixpinski_sdf(p - vec3(0.0, 0.0, h)).y
    ));
}
...
float calculate_ambient_occlusion(vec3 p, vec3 normal) {
    ...
    float occlusion = 0.0;
    float weight = 1.0 / float(ambient_occlusion_steps); // Cast to float
    ...
    for (int i = 0; i < int(ambient_occlusion_steps); i++) { // Cast to int
        ...
        float d = mixpinski_sdf(sample_point).y;
...
// Render function - directly from your code
vec3 render(vec3 ray_origin, vec3 ray_dir, vec2 screen_uv) {
...
void main() // ISF entry point
{
    ...
    // Time (ISF provides TIME automatically)
    float time = 32.0 + TIME * speed; // Use 'speed' uniform

    // Camera target and origin with ISF input offsets
    // Assuming camera_offset_x/y/z are implicitly passed floats
    vec3 ta = vec3( camera_offset_x, camera_offset_y, camera_offset_z );
    vec3 ro = ta + vec3(8.0, 2.2, 2.0 + 2.5 * sin(0.1 * time + 7.0) );
    mat3 ca = setCamera( ro, ta, 1.0 );

    // Screen coordinates centered and scaled by aspect ratio
    vec2 p = (2.0 * gl_FragCoord.xy - RENDERSIZE.xy) / RENDERSIZE.y;
    // Use zoom_factor for camera FOV/zoom
    vec3 rd = ca * normalize(vec3(p, zoom_factor)); 

    // Render the scene
    vec3 col = render(ro, rd, uv);

    // Apply final tone mapping and gamma correction
    col = col * 3.0 / (2.5 + col);
