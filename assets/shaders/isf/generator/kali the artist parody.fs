/*
{
    ...
    "INPUTS": [
        ...
        { "NAME": "FractalOffsetSpeed", "TYPE": "float", "DEFAULT": 0.41, "MIN": 0.0, "MAX": 1.0, "LABEL": "Fractal Offset Speed" },
        ...
        { "NAME": "FractalIterations", "TYPE": "float", "DEFAULT": 7.0, "MIN": 1.0, "MAX": 15.0, "LABEL": "Fractal Iterations" },
        { "NAME": "FractalMultiply", "TYPE": "float", "DEFAULT": 4.5, "MIN": 0.0, "MAX": 50.0, "LABEL": "Fractal Multiply" },
        { "NAME": "FractalGlowStrength", "TYPE": "float", "DEFAULT": 1.0, "MIN": 0.0, "MAX": 20.0, "LABEL": "Fractal Glow Str" },
        { "NAME": "FractalGlowDecay", "TYPE": "float", "DEFAULT": 4.0, "MIN": 0.01, "MAX": 5.0, "LABEL": "Fractal Glow Decay" },
        ...
        { "NAME": "ColorPulseSpeed", "TYPE": "float", "DEFAULT": 0.5, "MIN": 0.0, "MAX": 2.0, "LABEL": "Color Pulse Speed" },
        { "NAME": "ColorPulseAmplitude", "TYPE": "float", "DEFAULT": 0.6, "MIN": 0.0, "MAX": 1.0, "LABEL": "Color Pulse Amp" },
        { "NAME": "GlobalBrightness", "TYPE": "float", "DEFAULT": 0.08, "MIN": 0.0, "MAX": 3.0, "LABEL": "Global Brightness" },
        { "NAME": "PaletteChoice", "TYPE": "float", "DEFAULT": 1.5, "MIN": 0.0, "MAX": 5.0, "LABEL": "Color Palette", "ANNOTATIONS": { "0.0": "Classic", "1.0": "Warm", "2.0": "Cool", "3.0": "Vibrant Neon", "4.0": "Deep Space", "5.0": "Dreamy Pastel" } },
...
vec3 fractal(vec2 p, float t_scaled) {
    ...
    // Primary change: Reduced pow exponent from 10.0 to 3.0 for better visibility.
...
void main() {
    ...
    col *= vec3(BaseColorMixX, BaseColorMixY, BaseColorMixZ);

    // Apply color pulse
    float pulse = sin(t_scaled * ColorPulseSpeed) * ColorPulseAmplitude + (1.0 - ColorPulseAmplitude);
    col *= pulse;
