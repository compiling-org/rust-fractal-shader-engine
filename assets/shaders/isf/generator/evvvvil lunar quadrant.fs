/*
{
    ...
    "INPUTS": [
        ...
        {
            "NAME": "TextureNoiseScale",
            "TYPE": "float",
            "DEFAULT": 1.0,
            "MIN": 0.1,
            "MAX": 5.0,
            "LABEL": "Texture Noise Scale"
        },
        {
...
// Using texture2D for TEXTURE_0 (formerly iChannel0)
...
void main() {
  ...
  vec2 tnoi_local=vec2(texNoise(uv*gpo*17.0*TextureNoiseScale).r); // Apply TextureNoiseScale, explicit float
